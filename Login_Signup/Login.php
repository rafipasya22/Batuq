...
<head>
    ...
    <title>Login/Signup Batuq</title>
</head>
    ...
    <div class="container" id="container">
        <div class="form-container sign-up">
            ...
            <?php
                        if(isset($_POST['submit_signup'])){
                            ...
                            $select = " SELECT * FROM akun_batuq WHERE Email = '$Email' && PW = '$PW'";
                            $result = mysqli_query($conn, $select);
                            $already_exist = "SELECT Email FROM akun_batuq WHERE Email = '$Email'";
                            ...
                            if(mysqli_num_rows($result)>0){
                                ...
                                <?php
                                    ...
                                    $insert = "INSERT INTO akun_batuq(Nama_Depan, Nama_Belakang, Email, PW, Jenis_Akun) VALUES ('$Nama_Depan', '$Nama_Belakang', '$Email', '$PW', '$Jenis_Akun')";
        ...
        <div class="form-container sign-in">
            <form action="" method="post">
                ...
                <button href="../Dashboard/Home.php" class="button" type="submit" value="register" name="submit_login">Sign In</button>
            </form>
            <?php
                    if(isset($_POST['submit_login'])){
                        ...
                        $select = "SELECT * FROM akun_batuq WHERE Email = '$Email' AND PW = '$PW'";
                        $result = mysqli_query($conn, $select);
        ...
        <div class="toggle-container">
            <div class="toggle">
                ...
                <div class="toggle-panel toggle-right">
                    <h1>Selamat Datang!</h1>
                    <p>Sumber Belajar Qur'an yang Dapat Diakses Kapan saja, Dimana saja.
